...
import org.catthisj.protocols.payments.PaymentProtocol;
import org.catthisj.protocols.payments.PaymentProtocolException;
import org.catthisj.protocols.payments.PaymentSession;
import org.catthisj.script.ScriptBuilder;
import org.catthisj.store.*;
import org.catthisj.uri.catThisURI;
import org.catthisj.uri.BitcoinURIParseException;
import org.catthisj.utils.BriefLogFormatter;
import org.catthisj.wallet.DeterministicSeed;
import org.catthisj.wallet.DeterministicUpgradeRequiredException;
import org.catthisj.wallet.DeterministicUpgradeRequiresPassword;
...
import org.catthisj.core.listeners.BlocksDownloadedEventListener;
import org.catthisj.core.listeners.DownloadProgressTracker;
import org.catthisj.wallet.MarriedKeyChain;
import org.catthisj.wallet.Protos;
import org.catthisj.wallet.SendRequest;
import org.catthisj.wallet.Wallet;
import org.catthisj.wallet.WalletExtension;
import org.catthisj.wallet.WalletProtobufSerializer;
...
import static org.catthisj.core.Coin.parseCoin;
        ...
        if (location.startsWith("http") || location.startsWith(CoinDefinition.coinURIScheme)) {
            try {
                ...
                if (location.startsWith("http")) {
                    ...
                    catThisURI paymentRequestURI = new catThisURI(location);
