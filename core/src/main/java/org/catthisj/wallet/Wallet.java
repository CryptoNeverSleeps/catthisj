...
import org.catthisj.core.Message;
import org.catthisj.core.listeners.*;
import org.catthisj.core.TransactionConfidence.*;
import org.catthisj.crypto.*;
import org.catthisj.script.*;
import org.catthisj.signers.*;
import org.catthisj.utils.*;
import org.catthisj.wallet.Protos.Wallet.*;
import org.catthisj.wallet.WalletTransaction.*;
...
import org.catthisj.wallet.listeners.WalletChangeEventListener;
...
import org.catthisj.wallet.listeners.WalletEventListener;
import org.catthisj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.catthisj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
    ...
    private Wallet(Context context, KeyChainGroup keyChainGroup) {
        ...
        //this.version = this.keyChainGroup.getActiveKeyChain().getKeyChainType() == DeterministicKeyChain.KeyChainType.BIP44_CATS_ONLY? 1 : 0;
     ...
     * {@link org.catthisj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.catthisj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.catthisj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.catthisj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.catthisj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.catthisj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.catthisj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.catthisj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.catthisj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.catthisj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.catthisj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.catthisj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.catthisj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of catthisj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.catthisj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.catthisj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.catthisj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.catthisj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.catthisj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.catthisj.crypto.KeyCrypter,
     ...
     * {@link org.catthisj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.catthisj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.catthisj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.catthisj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.catthisj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.catthisj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
