...
/**
 * <p>A KeyChainGroup is used by the {@link org.catthisj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.catthisj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.catthisj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.catthisj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
