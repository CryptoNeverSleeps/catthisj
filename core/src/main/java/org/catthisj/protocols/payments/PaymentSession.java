...
package org.catthisj.protocols.payments;

import org.catthisj.core.*;
import org.catthisj.crypto.TrustStoreLoader;
import org.catthisj.params.MainNetParams;
import org.catthisj.protocols.payments.PaymentProtocol.PkiVerificationData;
import org.catthisj.uri.catThisURI;
import org.catthisj.utils.Threading;
import org.catthisj.wallet.SendRequest;
 ...
 *
 * <ul>
 * <li>A {@link catThisURI} object that conforms to BIP 0072</li>
 * <li>A url where the {@link Protos.PaymentRequest} can be fetched</li>
 * <li>Directly with a {@link Protos.PaymentRequest} object</li>
 * </ul>
 *
 * <p>If initialized with a catThisURI or a url, a network request is made for the payment request object and a
...
public class PaymentSession {
     ...
     * uri is a BIP-72-style catThisURI object that specifies where the {@link Protos.PaymentRequest} object may
     ...
     * be verified.</p>
     */
    public static ListenableFuture<PaymentSession> createFromBitcoinUri(final catThisURI uri) throws PaymentProtocolException {
     ...
     */
    public static ListenableFuture<PaymentSession> createFromBitcoinUri(final catThisURI uri, final boolean verifyPki)
     ...
     */
    public static ListenableFuture<PaymentSession> createFromBitcoinUri(final catThisURI uri, final boolean verifyPki, @Nullable final TrustStoreLoader trustStoreLoader)
            throws PaymentProtocolException {
        String url = uri.getPaymentRequestUrl();
        if (url == null)
            throw new PaymentProtocolException.InvalidPaymentRequestURL("No payment request URL (r= parameter) in catThisURI " + uri);
        try {
