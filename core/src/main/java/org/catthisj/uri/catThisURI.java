...
import org.catthisj.params.AbstractBitcoinNetParams;
...
public class catThisURI {
    ...
    /**
     * URI for Bitcoin network. Use {@link org.catthisj.params.AbstractBitcoinNetParams#BITCOIN_SCHEME} if you specifically
     * need Bitcoin, or use {@link org.catthisj.core.NetworkParameters#getUriScheme} to get the scheme
    ...
    /**
     * Constructs a new catThisURI from the given string. Can be for any network.
     *
     ...
     */
    public catThisURI(String uri) throws BitcoinURIParseException {
        this(null, uri);
    }
     ...
     */
    public catThisURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        checkNotNull(input);
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("catThisURI[");
        boolean first = true;
