...
public class CoinDefinition {
    ...
    public static final String coinName = "catThis";
    public static final String coinTicker = "CATS";
    public static final String coinURIScheme = "catthis";
    public static final String cryptsyMarketId = "155";
    public static final String cryptsyMarketCurrency = "cats";
    ...
    public static final long MAX_COINS = 500000000;                 //main.h:  MAX_MONEY
    ...
    // CATS 0.12
    //
    public static final int PROTOCOL_VERSION = 71000;          //version.h PROTOCOL_VERSION
    public static final int MIN_PROTOCOL_VERSION = 71000;        //version.h MIN_PROTO_VERSION
    ...
    public static final int Port    = 22711;       //protocol.h GetDefaultPort(testnet=false)
    ...
    public static final long PacketMagic = 0x492a6bd8;

    //Genesis Block Information from main.cpp: LoadBlockIndex
    static public long genesisBlockDifficultyTarget = 0x1e0ffff0;         //main.cpp: LoadBlockIndex
    static public long genesisBlockTime = 1584213602;                       //main.cpp: LoadBlockIndex
    static public long genesisBlockNonce = 7963834;                         //main.cpp: LoadBlockIndex
    static public String genesisHash = "00000d6de7c69fdf1cb7a4fee0855d54e8247469014c4723155d2369f59cd76e";  //main.cpp: hashGenesisBlock
    static public String genesisMerkleRoot = "fcf0ea61a89b2dc4f9a6ccb4d9387511037017839539dd478d1892d6760213b3";
    static public int genesisBlockValue = 0;                                                              //main.cpp: LoadBlockIndex
    //taken from the raw data of the block explorer
    static public String genesisTxInBytes = "04ffff001d0104334e6174696f6e616c20537569636964652050726576656e74696f6e204c6966656c696e6520312d3830302d3237332d38323535";//"04ffff001d01044c5957697265642030392f4a616e2f3230313420546865204772616e64204578706572696d656e7420476f6573204c6976653a204f76657273746f636b2e636f6d204973204e6f7720416363657074696e6720426974636f696e73";   //"limecoin se convertira en una de las monedas mas segura del mercado, checa nuestros avances"
    ...
    public static final String genesisTxPubKey = "04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f";

    //net.cpp strDNSSeed
    static public String[] dnsSeeds = new String[] {
            "104.207.140.233","155.138.202.38","108.224.49.202","144.202.2.218","45.77.149.76"
    };
    ...
    static public String[] testnetDnsSeeds = new String[] {
            "catthis-testnet.seed.fuzzbawls.pw",
            "catthis-testnet.seed2.fuzzbawls.pw",
            "s3v3nh4cks.ddns.net"
    };
    //from main.h: CAlert::CheckSignature
    public static final String SATOSHI_KEY = "0435401a5693de702378a538ad939ea03b5e3b2826f68431ba840df5f418e3f3e8590ba4fb0c36097179bb55ffc4a4e065dc2ff87edb6f3ce4232a71d253ed7fff";
    ...
    public static final String ID_MAINNET = "org.catthis.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.catthis.test";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "com.google.catthis.unittest";
