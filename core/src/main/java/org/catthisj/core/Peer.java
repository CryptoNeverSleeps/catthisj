...
import org.catthisj.net.StreamConnection;
import org.catthisj.store.BlockStore;
import org.catthisj.store.BlockStoreException;
import org.catthisj.utils.ListenerRegistration;
 ...
 * {@link org.catthisj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.catthisj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.catthisj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link org.catthisj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.catthisj.core.TxConfidenceTable}
    ...
    protected void processMessage(Message m) throws Exception {
        ...
        else if(m instanceof SporkMessage)
        {
            ...
            // todo furszy: check catthis masternodes
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // catthisj is a client mode implementation. That means there's not much point in us talking to other client
...
//            if(!instantSend.mapTxLockVotes.containsKey(item.hash))
     ...
     * Once the pong is received the value returned by {@link org.catthisj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.catthisj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.catthisj.core.Peer#ping()} has never
