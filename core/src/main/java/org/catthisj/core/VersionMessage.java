...
public class VersionMessage extends Message {
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for catthisj
     * users might look like "/catthisj:0.13/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/catthisj:1.0/MultiBit:1.0(Windows)/". Therefore the / ( and ) characters are reserved in all these
