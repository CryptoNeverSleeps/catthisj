...
import org.catthisj.net.*;
import org.catthisj.net.discovery.*;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of catthisj fixes the known
     ...
     * {@link org.catthisj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.catthisj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.catthisj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.catthisj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.catthisj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.catthisj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.catthisj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.catthisj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.catthisj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a catthisj based app running in SPV mode to fully validating security.
     */
