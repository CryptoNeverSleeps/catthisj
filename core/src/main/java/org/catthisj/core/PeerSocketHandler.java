...
import org.catthisj.net.AbstractTimeoutHandler;
import org.catthisj.net.MessageWriteTarget;
 ...
 * {@link org.catthisj.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamConnection {
     ...
     * called automatically by {@link org.catthisj.net.NioClient} or
     * {@link org.catthisj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
