...
import org.catthisj.core.AbstractBlockChain;
import org.catthisj.core.Address;
import org.catthisj.core.Block;
import org.catthisj.core.BlockChain;
...
import org.catthisj.core.StoredBlock;
...
import org.catthisj.wallet.Protos.Wallet.EncryptionType;
...
import static org.catthisj.core.Utils.HEX;
import static org.catthisj.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: catthisj won't check in SPV mode and this is easier than other mutations.
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("catthisj-unit-test", null);
